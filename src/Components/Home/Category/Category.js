      ...
      <div className=' container sm:grid grid-cols-6 gap-4'>
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-white max-w-sm">
            <Link to={'/laptop'} >
              <img className="rounded-t-lg" src="https://i.ibb.co/QD5Bw08/vivobook-15-x515ea-01-228x228.jpg" alt="" />
              <div className="p-6">
        ...
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-white max-w-sm">
            <Link to={'/acr'}>
              <img className="rounded-t-lg" src="https://i.ibb.co/MP9sC0r/rs200-01-500x500.jpg" alt="" />
        ...
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-white max-w-sm">
            <Link to={'/smartwatch'}>
              <img className="rounded-t-lg" src="https://i.ibb.co/sFTkcz0/sw04-01-228x228.jpg" alt="" />
              <div className="p-6">
        ...
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-white max-w-sm">
            <Link to={'/smartmonitor'}>
              <img className="rounded-t-lg" src="https://i.ibb.co/KzFNxs2/xiaomi-xmmnt27hq-monitor-2-500x500.jpg" alt="" />
              <div className="p-6">
